...
//if no errors
  ...
  $contact_m->update($data , $conditions);

  $messages['ok'] = 'Contact successfully updated!';
...
<div class="container">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <input type="text" value="<?php echo $contact['name']; ?>" name="name" class="form-control">
      </div>

      <div class="form-group">
          <label for="" class="control-label">Phone</label>
          <input type="tel" value="<?php echo $contact['phone']; ?>"  name="phone" class="form-control">
      </div>

      <div class="form-group">
          <label for="" class="control-label">Email</label>
          <input type="email" value="<?php echo $contact['email']; ?>"  name="email" class="form-control">
      </div>

      <div class="form-group">
          <label for="" class="control-label">Address</label>
          <textarea name="address" id="address" cols="30" rows="10" class="form-control"><?php echo $contact['address']; ?></textarea>
      </div>
